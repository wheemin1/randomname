...
6g0YPHUUcxUXPjj2Dj767iTCgQB8Pi/vhCrKOgO6nsd37kO5XALhhWibkBDOLi4uxrdu3SqCVa/V
...
const binaryString = atob(faviconBase64.replace(/\s/g, ''));
...
// Write to file
require('fs').writeFileSync('client/public/favicon.png', bytes);
